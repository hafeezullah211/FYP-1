  ...
  try {
    await mongoose
      .connect(
        ...
        // `mongodb+srv://hafeez_ullah:hafeez123@onspotcluster0.sltcg.mongodb.net/onSpot?retryWrites=true&w=majority`,
        // `mongodb://hafeez_u_llah:Aabc@6163@firstcluster-shard-00-00.vcpbg.mongodb.net:27017,firstcluster-shard-00-01.vcpbg.mongodb.net:27017,firstcluster-shard-00-02.vcpbg.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-13tobm-shard-0&authSource=admin&retryWrites=true&w=majority`,
        {
